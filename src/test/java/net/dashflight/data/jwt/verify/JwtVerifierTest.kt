...
class JwtVerifierTest {
    ...
    fun testVerifyExpiredToken() {
        ...
        val response = verifier.verifyToken(token, fingerprint)

        Assert.assertThat(response, instanceOf(JwtVerificationResponse.Error::class.java))
    }
    ...
    fun testVerifyValidToken() {
        ...
        when (val response = verifier.verifyToken(token, fingerprint)) {
